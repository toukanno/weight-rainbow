            ...
            <div class="record-list">
              ${state.records.length ? renderRecordList() : `<div class="empty-state">
                ...
                <div class="empty-state-actions">
                  ...
                  <button type="button" class="btn secondary" data-mode="voice">\u{1F3A4} ${t("entry.voice")}</button>
                  <button type="button" class="btn secondary" data-mode="photo">\u{1F4F7} ${t("entry.photo")}</button>
                </div>
              </div>`}
            </div>
